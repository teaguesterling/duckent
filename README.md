...
| [`docs/12-tree-contract-lesson-v13.html`](docs/12-tree-contract-lesson-v13.html) | The public teaching layer: a hands-on lesson from `grep` to `CREATE TREE`. Self-contained HTML. Published at <https://teaguesterling.github.io/pages/static/tree-contract-lesson.html>. |
